...
%>
<%
if (oArchivo.AbreArchivo(sRutaHistoria,"fAnexo3XVI.html") && oArchivowa.AbreArchivo(sRutaAttach,"fAnexo3XVI.html")){
	sAnexo 					= "III.16";
	Anexo3XVI oAnexo	 	= new Anexo3XVI();
	iIdAnexo 				= oAnexo.GetIdAnexo();
	oAnexoEstatus.Get(iIdFuncionario, iIdAnexo);
	sEstatus 				= oAnexoEstatus.GetEstatus();
	sAux = "\n				<tr><td class='TituloParrafo' width='70%'>&nbsp;&nbsp;ANEXO III.16 - RELACIÓN DE ARCHIVO MUERTO&nbsp;&nbsp;</td></tr>";
%>
