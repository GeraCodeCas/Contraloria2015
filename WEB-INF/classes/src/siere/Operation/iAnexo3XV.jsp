...
<html>
<head>
	<title>Entrega - Recepción : Anexo III.15 (Impresión)</title>
...
<tr>
	...
	<TABLE cellPadding="0" cellSpacing="0" width="100%" BORDER="1" BORDERCOLOR="white">
		<TR><TD class="TituloParrafoImpr">RELACIÓN DE ARCHIVO VIGENTE</TD></TR>  
	</TABLE>
	<TABLE cellPadding="0" cellSpacing="0" width="100%" BORDER="1" BORDERCOLOR="white">
		<TR align="middle">
			<td class="TituloMenuImpr" width="180">IDENTIFICACIÓN DEL ARCHIVO</TD>
			<td class="TituloMenuImpr" width="180">EXPEDIENTE</TD>
			<td class="TituloMenuImpr" width="180">PERIODO COMPRENDIDO</TD>
			<td class="TituloMenuImpr" width="180">UBICACIÓN</TD>
