...
if (MultipartFormDataRequest.isMultipartFormData(request)){
	...
	if ((sOpcion != null) && (sOpcion.equalsIgnoreCase("UpLoad"))) {
        ...
        if ((files != null) || (!files.isEmpty())){
			...
			oCarga.setTabla("PasoAnexo3XVII");
			oCarga.setProcedimiento("Anexo3XVII");
			...
			oSeguridad.Bitacora(sUsuario, "Carga", "Anexo III.17", request.getRemoteAddr(), request.getRemoteHost(), request.getHeader("User-Agent"));
	  	}
	}
}
...
<head>
	...
	<title>Entrega - Recepción : Anexo III.17 (Archivos de Carga Masiva)</title>
	...
	<script>
		...
		function errores(){
			popBoxRize("Errores", 800, 600, "fErrAnexo3XVII.jsp?sIdFuncionario=<%=sIdFuncionario%>");
		}
	</script>
</head>
<body id="idBodyc">
<form method="post" action="cAnexo3XVII.jsp" name="upform" enctype="multipart/form-data">
