...
if (MultipartFormDataRequest.isMultipartFormData(request)){
	...
	if ((sOpcion != null) && (sOpcion.equalsIgnoreCase("UpLoad"))) {
        ...
        if ((files != null) || (!files.isEmpty())){
			...
			int[] iPaso = {20, 50, 50, 50, 20, 20, 20, 20, 255, 1};
			...
			oCarga.setTabla("PasoAnexo3XII");
			oCarga.setProcedimiento("Anexo3XII");
			...
			oSeguridad.Bitacora(sUsuario, "Carga", "Anexo III.12", request.getRemoteAddr(), request.getRemoteHost(), request.getHeader("User-Agent"));
		}
	}
}
...
<head>
	...
	<title>Entrega - Recepción : Anexo III.12 (Archivos de Carga Masiva)</title>
	...
	<script>
		...
		function errores(){
			popBoxRize("Errores", 800, 600, "fErrAnexo3XII.jsp?sIdFuncionario=<%=sIdFuncionario%>");
		}
	</script>
</head>
<body id="idBodyc">
<form method="post" action="cAnexo3XII.jsp" name="upform" enctype="multipart/form-data">
