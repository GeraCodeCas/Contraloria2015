...
if (MultipartFormDataRequest.isMultipartFormData(request)){
	...
	if ((sOpcion != null) && (sOpcion.equalsIgnoreCase("UpLoad"))) {
    	...
    	if ((files != null) || (!files.isEmpty())){
			...
			int[] iPaso = {20, 100, 20, 20, 20, 30, 10, 9, 9, 255, 1};
			...
			oCarga.setTabla("PasoAnexo3XI");
			oCarga.setProcedimiento("Anexo3XI");
			...
			oSeguridad.Bitacora(sUsuario, "Carga", "Anexo III.11", request.getRemoteAddr(), request.getRemoteHost(), request.getHeader("User-Agent"));
        }
	}
}
...
<head>
	...
	<title>Entrega - Recepción : Anexo III.11 (Archivos de Carga Masiva)</title>
	...
	<script>
		...
		function errores(){
			popBoxRize("Errores", 800, 600, "fErrAnexo3XI.jsp?sIdFuncionario=<%=sIdFuncionario%>");
		}
	</script>
</head>
<body id="idBodyc">
<form method="post" action="cAnexo3XI.jsp" name="upform" enctype="multipart/form-data">
