...
if (MultipartFormDataRequest.isMultipartFormData(request)){
	...
	if ((sOpcion != null) && (sOpcion.equalsIgnoreCase("UpLoad"))) {
		...
		if ((files != null) || (!files.isEmpty())){
			...
			oCarga.setTabla("PasoAnexo2IV3");
			oCarga.setProcedimiento("Anexo2IV3");
			...
			oSeguridad.Bitacora(sUsuario, "Carga", "Anexo II.4.3", request.getRemoteAddr(), request.getRemoteHost(), request.getHeader("User-Agent"));
		}
	}
}
...
<head>
	...
	<title>Entrega - Recepción : Anexo II.4.3 (Archivos de Carga Masiva)</title>
	...
	<script>
		...
		function errores(){
			popBoxRize("Errores", 800, 600, "fErrAnexo2IV3.jsp?sIdFuncionario=<%=sIdFuncionario%>");
		}
	</script>
</head>
<body id="idBodyc">
<form method="post" action="cAnexo2IV3.jsp" name="upform" enctype="multipart/form-data">
