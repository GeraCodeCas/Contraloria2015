...
if (MultipartFormDataRequest.isMultipartFormData(request)){
	...
	if ((sOpcion != null) && (sOpcion.equalsIgnoreCase("UpLoad"))) {
        ...
        if ((files != null) || (!files.isEmpty())){
			...
			int[] iPaso = {50, 100, 50, 50, 1, 20, 20, 20, 255};
			...
			oCarga.setTabla("PasoAnexo3IV1");
			oCarga.setProcedimiento("Anexo3IV1");
...
<head>
	...
	<script>
		...
		function errores(){
			popBoxRize("Errores", 800, 600, "fErrAnexo3IV1.jsp?sIdFuncionario=<%=sIdFuncionario%>");
		}
	</script>
</head>
<body id="idBodyc">
<form method="post" action="cAnexo3IV1.jsp" name="upform" enctype="multipart/form-data">
