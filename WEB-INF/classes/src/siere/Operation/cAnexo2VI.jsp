...
if (MultipartFormDataRequest.isMultipartFormData(request)){
	...
	if ((sOpcion != null) && (sOpcion.equalsIgnoreCase("UpLoad"))) {
		...
		if ((files != null) || (!files.isEmpty())){
			...
			oCarga.setTabla("PasoAnexo2VI");
			oCarga.setProcedimiento("Anexo2VI");
			...
			oSeguridad.Bitacora(sUsuario, "Carga", "Anexo II.6", request.getRemoteAddr(), request.getRemoteHost(), request.getHeader("User-Agent"));
		}
	}
}
String sPath 			= "../";
...
<head>
	...
	<title>Entrega - Recepción : Anexo II.6 (Archivos de Carga Masiva)</title>
	...
	<script>
		...
		function errores(){
			popBoxRize("Errores", 800, 600, "fErrAnexo2VI.jsp?sIdFuncionario=<%=sIdFuncionario%>");
		}
	</script>
</head>
<body id="idBodyc">
<form method="post" action="cAnexo2VI.jsp" name="upform" enctype="multipart/form-data">
