...
int iIdAnexo = oAnexo3II.GetIdAnexo();
%>
<%@include file="fAnexoInicia.jsp"%>
<html>
<head>
	<title>Entrega - Recepción : Anexo III.2</title>
...
<FORM action="pAnexo3II.jsp" name="forma" method="post" >
	<input type="hidden" name="sOpcion" value="">
	<input type="hidden" name="sCodigo" value="<%=sCodigo%>"> 
	<TABLE align=center border=0 cellPadding=0 cellSpacing=0 width="100%">
		<TR>
			<TD  colspan="3" class="TituloParrafo" width="70%">&nbsp;&nbsp;ANEXO III.2 - MARCO JURÍDICO DE ACTUACIÓN</TD>
		</TR>
		<TR>
		<TD width="70%">
		...
		if( !sMensageEstatus.equals("") ) {
			...
			<%}%>
			<a onmouseover="this.style.cursor='hand'" style="cursor:normal" onclick="imprimir(<%=iIdFuncionario%>, 'iAnexo3II.jsp');"><img src="<%=sPath%>Images/Impresora.jpg" ></a>&nbsp;&nbsp;
			<a onmouseover="this.style.cursor='hand'" style="cursor:normal" onclick="ayuda('../Help/aAnexo3II.htm');"><img src="<%=sPath%>Images/Ayuda.jpg" ></a></td> 
			<TD align=right>
	...
	<!-- Etiqueta donde se aplican los encabezados de las tablas-->
		<TR align="middle">
			<td class="TituloMenu" colspan="2"><a onmouseover="this.style.cursor='hand'" style="cursor:normal" onclick="edit(<%=iIdFuncionario%>);">Marco Jurídico de Actuación</a></td>
		</TR>
		<%
	if(!sEstatus.equals("0")){
		...
		if(sOpcion.equals("EDIT") && sCodigo.equals(iIdFuncionario+"") ){%>
 		<TR>
			<TD align="center"><textarea class="txtBox" name="sMarcoJuridico" id="sMarcoJuridico" rows="10" cols="100" onKeyPress="isInValid();" onpaste="validaPasteStr(this);"><%=vMarcoJuridico%></textarea></TD>
		</TR><%
		}
		
		if(!sOpcion.equals("NEW") && !sOpcion.equals("EDIT")){%>
		<TR>
  		<TD>&nbsp;<a onmouseover="this.style.cursor='hand'" style="cursor:normal" onclick="edit(<%=iIdFuncionario%>);"><textarea class="txtBox" onmouseover="this.style.cursor='hand'" name="sMarcoJuridico" id="sMarcoJuridico" style="border: 0; background-color: transparent; transparent;overflow-y:hidden; width:'100%'; height='100%'" readonly rows="50" cols="120" onKeyPress="isInValid();" onpaste="validaPasteStr(this);"><%=vMarcoJuridico%></textarea></a></TD>
		</TR><%
		}%>
</TABLE><%
	} else {%>
