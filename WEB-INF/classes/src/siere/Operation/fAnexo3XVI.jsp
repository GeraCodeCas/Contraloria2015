...
<html>
<head>
	<title>Entrega - Recepción : Anexo III.16</title>
...
<FORM action="pAnexo3XVI.jsp" name="forma" method="post" >
	<input type="hidden" name="sOpcion" value="">
	<input type="hidden" name="sCodigo" value="<%=sCodigo%>"> 
	<TABLE align=center border=0 cellPadding=0 cellSpacing=0 width="100%">
		<tr>
			<td class="TituloParrafo" colspan="3">&nbsp;&nbsp;ANEXO III.16 - RELACIÓN DE ARCHIVO MUERTO&nbsp;&nbsp;</td>
		</tr>
		<tr>
		...
		if( !sMensageEstatus.equals("") ) {
			...
			if(!bSoloLectura) { %>
			<a onmouseover="this.style.cursor='hand'" style="cursor:normal" onclick="Carga('<%=iIdFuncionario%>','<%=iIdAnexo%>', 'cAnexo3XVI.jsp');"><img src="<%=sPath%>Images/Carga.jpg" ></a>&nbsp;&nbsp;
			...
			<%}%>
			<a onmouseover="this.style.cursor='hand'" style="cursor:normal" onclick="imprimir('<%=iIdFuncionario%>', 'iAnexo3XVI.jsp');"><img src="<%=sPath%>Images/Impresora.jpg" ></a>&nbsp;&nbsp;
			<a onmouseover="this.style.cursor='hand'" style="cursor:normal" onclick="ayuda('<%=sPath%>Help/aAnexo3XVI.htm');"><img src="<%=sPath%>Images/Ayuda.jpg" ></a></td> 
			<TD align=right>
<%//AGREGADO POR VALIDACION ESTATUS 1
			if(!bSoloLectura) {
...
%>
		<TR align="middle">
			...
			<TD>
				<INPUT class="txtBox" name="sExpediente" id="sExpediente" type="Text" size="50" maxlength="255" value="" onKeyPress="isInValid();" onpaste="validaPasteStr(this);"></TD>
			<TD>
...
%>
		<TR align="middle">
			...
			<TD>
				<INPUT class="txtBox" name="sExpediente" id="sExpediente" type="Text" size="50" maxlength="255" value="<%=sExpediente%>" onKeyPress="isInValid();" onpaste="validaPasteStr(this);"></TD>
			<TD>
