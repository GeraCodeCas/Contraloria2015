...
if (MultipartFormDataRequest.isMultipartFormData(request)){
	...
	if ((sOpcion != null) && (sOpcion.equalsIgnoreCase("UpLoad"))) {
        ...
        if ((files != null) || (!files.isEmpty())){
			...
			int[] iPaso = {20, 50, 20, 20, 20, 20, 50, 150, 1};
			...
			oCarga.setTabla("PasoAnexo3V1");
			oCarga.setProcedimiento("Anexo3V1");
			...
			oSeguridad.Bitacora(sUsuario, "Carga", "Anexo III.5.1", request.getRemoteAddr(), request.getRemoteHost(), request.getHeader("User-Agent"));
		}
	}
}
...
<head>
	...
	<title>Entrega - Recepción : Anexo III.5.1 (Archivos de Carga Masiva)</title>
	...
	<script>
		...
		function errores(){
			popBoxRize("Errores", 800, 600, "fErrAnexo3V1.jsp?sIdFuncionario=<%=sIdFuncionario%>");
		}
	</script>
</head>
<body id="idBodyc">
<form method="post" action="cAnexo3V1.jsp" name="upform" enctype="multipart/form-data">
