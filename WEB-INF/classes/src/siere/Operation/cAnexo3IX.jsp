...
if (MultipartFormDataRequest.isMultipartFormData(request)){
	...
	if ((sOpcion != null) && (sOpcion.equalsIgnoreCase("UpLoad"))) {
        ...
        if ((files != null) || (!files.isEmpty())){
			...
			int[] iPaso = {50, 50, 100, 50, 1,1,1,255};
			...
			oCarga.setTabla("PasoAnexo3IX");
			oCarga.setProcedimiento("Anexo3IX");
			...
			oSeguridad.Bitacora(sUsuario, "Carga", "Anexo III.9", request.getRemoteAddr(), request.getRemoteHost(), request.getHeader("User-Agent"));
        }
	}
}
...
<head>
	...
	<title>Entrega - Recepción : Anexo III.9 (Archivos de Carga Masiva)</title>
	...
	<script>
		...
		function errores(){
			popBoxRize("Errores", 800, 600, "fErrAnexo3IX.jsp?sIdFuncionario=<%=sIdFuncionario%>");
		}
	</script>
</head>
<body id="idBodyc">
<form method="post" action="cAnexo3IX.jsp" name="upform" enctype="multipart/form-data">
