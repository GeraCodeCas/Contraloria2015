...
<html>
<head>
	<title>Entrega - Recepción : Anexo III.5.6 (Impresión)</title>
...
<tr>
	...
	<TR><TD class="TituloParrafoImpr">RELACIÓN DE OBRAS DE ARTE Y DECORACIÓN</TD></TR>  
	</TABLE>
	<TABLE cellPadding="0" cellSpacing="0" width="100%" BORDER="1" BORDERCOLOR="white">
		<TR align="middle">
			<td class="TituloMenuImpr" width="150">CLAVE<br>INVENTARIO</TD>
			<td class="TituloMenuImpr" width="150">NÚMERO DE<br>FACTURA</TD>
			<td class="TituloMenuImpr" width="100">FECHA<BR>FACTURA</TD>
...
if(!sEstatus.equals("0")){
		...
		String vClave = oAnexo3V6.GetClave(i)!=null?oAnexo3V6.GetClave(i):"";
		String vNumFactura = oAnexo3V6.GetNumFactura(i)!=null?oAnexo3V6.GetNumFactura(i):"";
		String vFecha = oAnexo3V6.GetFecha(i)!=null?oAnexo3V6.GetFecha(i):"";
		String vConcepto = oAnexo3V6.GetConcepto(i)!=null?oAnexo3V6.GetConcepto(i):"";
		...
		String vImporte = oAnexo3V6.GetImporte(i)!=null?oAnexo3V6.GetImporte(i):"";
		...
		String vDesTipo = oAnexo3V6.GetDesTipo(oAnexo3V6.GetTipoPos(oAnexo3V6.GetTipo(i)));
		...
		<TR align="left" bgcolor="<%=sBackColor%>");">
			...
			<TD class="ContenidoImpr"><%=vNumFactura%></TD>
			<TD class="ContenidoImpr" align="center"><%=vFecha%></TD>
			<TD class="ContenidoImpr"><%=vConcepto%></TD>
			<TD class="ContenidoImpr" align="right"><%=vImporte%></TD>
