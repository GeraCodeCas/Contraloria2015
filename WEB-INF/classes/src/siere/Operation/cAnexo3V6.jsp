...
if (MultipartFormDataRequest.isMultipartFormData(request)){
	...
	if ((sOpcion != null) && (sOpcion.equalsIgnoreCase("UpLoad"))) {
        ...
        if ((files != null) || (!files.isEmpty())){
			...
			oCarga.setTabla("PasoAnexo3V6");
			oCarga.setProcedimiento("Anexo3V6");
			...
			oSeguridad.Bitacora(sUsuario, "Carga", "Anexo III.5.6", request.getRemoteAddr(), request.getRemoteHost(), request.getHeader("User-Agent"));
		}
	}
}
String sPath 			= "../";
...
<head>
	...
	<title>Entrega - Recepción : Anexo III.5.6 (Archivos de Carga Masiva)</title>
	...
	<script>
		...
		function errores(){
			popBoxRize("Errores", 800, 600, "fErrAnexo3V6.jsp?sIdFuncionario=<%=sIdFuncionario%>");
		}
	</script>
</head>
<body id="idBodyc">
<form method="post" action="cAnexo3V6.jsp" name="upform" enctype="multipart/form-data">
