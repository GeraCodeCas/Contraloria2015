...
int	sTipoUsuario = 2; // request.getParameter("sTipoUsuario")!= null ? request.getParameter("sTipoUsuario"): "2";
String	sMensaje = "";
...
if(sOpcion.equals("SAVE")){
	if(sCodigo.equals("0")){
		iIdUsuario = oUsuario.InsertUsrRepresentante();
		if(iIdUsuario>=0){
			iIdEnlace = oEnlace.Insert(sNombre, sApePaterno, sApeMaterno, iIdUsuario, 
				java.lang.Integer.parseInt(sIdUnidadGobierno), sTipoUsuario);
...
%>
	<title>Entrega - Recepción : Representantes (Procesando...)</title>
</head>

<body>
<form action="fRepresentante.jsp" name="forma" method="post" target="_parent">
