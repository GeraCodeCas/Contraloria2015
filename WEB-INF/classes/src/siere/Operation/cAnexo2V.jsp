...
if (MultipartFormDataRequest.isMultipartFormData(request)){
	...
	if ((sOpcion != null) && (sOpcion.equalsIgnoreCase("UpLoad"))) {
		...
		if ((files != null) || (!files.isEmpty())){
			...
			oCarga.setTabla("PasoAnexo2V");
			oCarga.setProcedimiento("Anexo2V");
			...
			oSeguridad.Bitacora(sUsuario, "Carga", "Anexo II.5", request.getRemoteAddr(), request.getRemoteHost(), request.getHeader("User-Agent"));
        }
	}
}
...
<head>
	...
	<title>Entrega - Recepción : Anexo II.5 (Archivos de Carga Masiva)</title>
	...
	<script>
		...
		function errores(){
			popBoxRize("Errores", 800, 600, "fErrAnexo2V.jsp?sIdFuncionario=<%=sIdFuncionario%>");
		}
	</script>
</head>
<body id="idBodyc">
<form method="post" action="cAnexo2V.jsp" name="upform" enctype="multipart/form-data">
