...
if (MultipartFormDataRequest.isMultipartFormData(request)){
	...
	if ((sOpcion != null) && (sOpcion.equalsIgnoreCase("UpLoad"))) {
        ...
        if ((files != null) || (!files.isEmpty())){
			...
			oCarga.setTabla("PasoAnexo3V3");
			oCarga.setProcedimiento("Anexo3V3");
			...
			oSeguridad.Bitacora(sUsuario, "Carga", "Anexo III.5.3", request.getRemoteAddr(), request.getRemoteHost(), request.getHeader("User-Agent"));
		}
	}
}
String sPath 			= "../";
...
<head>
	...
	<title>Entrega - Recepción : Anexo III.5.3 (Archivos de Carga Masiva)</title>
	...
	<script>
		...
		function errores(){
			popBoxRize("Errores", 800, 600, "fErrAnexo3V3.jsp?sIdFuncionario=<%=sIdFuncionario%>");
		}
	</script>
</head>
<body id="idBodyc">
<form method="post" action="cAnexo3V3.jsp" name="upform" enctype="multipart/form-data">
