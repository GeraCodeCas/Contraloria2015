...
if (MultipartFormDataRequest.isMultipartFormData(request)){
	...
	if ((sOpcion != null) && (sOpcion.equalsIgnoreCase("UpLoad"))) {
        ...
        if ((files != null) || (!files.isEmpty())){
			...
			oCarga.setTabla("PasoAnexo3IV5");
			oCarga.setProcedimiento("Anexo3IV5");
...
<head>
	...
	<title>Entrega - Recepción : Anexo III.4.5 (Archivos de Carga Masiva)</title>
	...
	<script>
		...
		function errores(){
			popBoxRize("Errores", 800, 600, "fErrAnexo3IV5.jsp?sIdFuncionario=<%=sIdFuncionario%>");
		}
	</script>
</head>
<body id="idBodyc">
<form method="post" action="cAnexo3IV5.jsp" name="upform" enctype="multipart/form-data">
