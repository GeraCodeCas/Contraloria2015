...
if (MultipartFormDataRequest.isMultipartFormData(request)){
	...
	if ((sOpcion != null) && (sOpcion.equalsIgnoreCase("UpLoad"))) {
        ...
        if ((files != null) || (!files.isEmpty())){
			...
			oCarga.setTabla("PasoAnexo3VI");
			oCarga.setProcedimiento("Anexo3VI");
			...
			oSeguridad.Bitacora(sUsuario, "Carga", "Anexo III.6", request.getRemoteAddr(), request.getRemoteHost(), request.getHeader("User-Agent"));
		}
	}
}
String sPath 			= "../";
...
<head>
	...
	<title>Entrega - Recepción : Anexo III.6 (Archivos de Carga Masiva)</title>
	...
	<script>
		...
		function errores(){
			popBoxRize("Errores", 800, 600, "fErrAnexo3VI.jsp?sIdFuncionario=<%=sIdFuncionario%>");
		}
	</script>
</head>
<body id="idBodyc">
<form method="post" action="cAnexo3VI.jsp" name="upform" enctype="multipart/form-data">
