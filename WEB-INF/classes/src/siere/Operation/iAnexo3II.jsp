...
<html>
<head>
	<title>Entrega - Recepción : Anexo III.2 (Impresión)</title>
...
<TABLE align=center border=0 cellPadding=0 cellSpacing=0 width="900">
		<TR>
			<TD  colspan="3" class="TituloParrafoImpr" width="900">MARCO JURÍDICO DE ACTUACIÓN</TD>
		</TR>
		<TR>
</TABLE>
	<TABLE align="center" cellPadding="0" cellSpacing="0" width="900" BORDER="1" BORDERCOLOR="White">
		<TR>
				<TD class="TituloMenuImpr" width="900" align="center">Marco Jurídico de Actuación</TD>
		</TR>
		<%
		...
		//Primer Elemento que su contenido puede llevar a un salto de pagina
			...
			if(iLenCol > 130){
				...
				String temp = vMarcoJuridico;
				vMarcoJuridico = "";
				iRowCountTemp = 0 ;
				for(int x=1;x<=(iRowsXCol);x++){
					int max = (130*x)<=iLenCol ? (130*x) : iLenCol;
					if( (x + iRowsAnt) <= iMaxRowXPag) {
						vMarcoJuridico = vMarcoJuridico + temp.substring((130*(x-1)), max) + "<br>";
						}
					else {
		...
		<TR>
  		<TD width="900" class="ContenidoImpr1Col"><%=vMarcoJuridico%></TD>
		</TR>
  <%
...
<tr>
	...
	<TABLE align="center" cellPadding="0" cellSpacing="0" width="900" BORDER="1" BORDERCOLOR="White">
		<TR>
				<TD width="900" class="TituloMenuImpr" align="center">Marco Jurídico de Actuación</TD>
		</TR>
...
<TABLE align=center border=0 cellPadding=0 cellSpacing=0 width="900">
		<TR>
			<TD  colspan="3" class="TituloParrafoImpr" width="70%">MARCO JURÍDICO DE ACTUACIÓN</TD>
		</TR>
		<TR>
</TABLE>
	<TABLE width="100%">
