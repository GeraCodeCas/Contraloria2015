...
if (MultipartFormDataRequest.isMultipartFormData(request)){
	...
	//*************Nota : aqui va el IdTipo que es numeric 5(6,0)...hay que ver como lo cargamos***********************************
			int[] iPaso = {1, 255, 10, 50, 255, 20, 255, 255};
			...
			oCarga.setTabla("PasoAnexo1II");
			oCarga.setProcedimiento("Anexo1II");
			...
			oSeguridad.Bitacora(sUsuario, "Carga", "Anexo I.2", request.getRemoteAddr(), request.getRemoteHost(), request.getHeader("User-Agent"));
		}
	}
}
...
<head>
	...
	<title>Entrega - Recepción : Anexo I.2(Archivos de Carga Masiva)</title>
	...
	<script>
		...
		function errores(){
			popBoxRize("Errores", 800, 600, "fErrAnexo1II.jsp?sIdFuncionario=<%=sIdFuncionario%>");
		}
	</script>
</head>
<body id="idBodyc">
<form method="post" action="cAnexo1II.jsp" name="upform" enctype="multipart/form-data">
