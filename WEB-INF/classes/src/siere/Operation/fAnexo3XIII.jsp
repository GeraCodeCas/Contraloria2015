...
'Fecha:		14.Nov.2002
'Compañia:	CONSISS
'Ultima Modificacion:6-Dic-2002
...
<html>
<head>
	<title>Entrega - Recepción : Anexo III.13</title>
...
<FORM action="pAnexo3XIII.jsp" name="forma" method="post" >
	<input type="hidden" name="sOpcion" value="">
	<input type="hidden" name="sCodigo" value="<%=sCodigo%>"> 
	<TABLE align=center border=0 cellPadding=0 cellSpacing=0 width="100%">
		<TR>
			<TD class="TituloParrafo" colspan="3">&nbsp;&nbsp;ANEXO III.13 - RELACIÓN DE COMPROMISOS PRESIDENCIALES PENDIENTES&nbsp;&nbsp;</TD>
		<tr>
		...
		if( !sMensageEstatus.equals("") ) {
			...
			<%}%>
			<a onmouseover="this.style.cursor='hand'" style="cursor:normal" onclick="imprimir(<%=iIdFuncionario%>, 'iAnexo3XIII.jsp');"><img src="<%=sPath%>Images/Impresora.jpg" ></a>&nbsp;&nbsp;
			<a onmouseover="this.style.cursor='hand'" style="cursor:normal" onclick="ayuda('<%=sPath%>Help/aAnexo3XIII.htm');"><img src="<%=sPath%>Images/Ayuda.jpg" ></a></td> 
			<TD align=right>
<%//AGREGADO POR VALIDACION ESTATUS
	if(!bSoloLectura) {
...
%>
		<TR align="middle">
			...
			<TD>
				<INPUT class="txtBox" name="sFecha" id="sFecha" type="Text" size="10" maxlength="9" readonly value="">&nbsp;<img src="<%=sPath%>Images/Fecha.gif" align="top" border=0 onclick="fPopCalendar(sFecha, sFecha)"></TD>
			<TD>
			...
			<TD>
				<INPUT class="txtNumeric" name="sAvanceFisico" id="sAvanceFisico" type="Text" size="20" maxlength="3" value="" onkeypress="valida(this);" onpaste="return validaPasteNum(this);"></TD>
			<TD>
				<INPUT class="txtNumeric" name="sAvanceFinanciero" id="sAvanceFinanciero" type="Text" size="20" maxlength="3" value="" onkeypress="valida(this);" onpaste="return validaPasteNum(this);"></TD>
		</TR>
<%
		}
		int intContador = 0;
...
%>
		<TR align="left" bgcolor="<%=sBackColor%>">
			...
			<TD>
				<INPUT class="txtBox" name="sFecha" id="sFecha" type="Text" size="10" maxlength="9" readonly value="<%=sFecha%>">&nbsp;<img src="<%=sPath%>Images/Fecha.gif" align="top" border=0 onclick="fPopCalendar(sFecha, sFecha)"></TD>
			<TD>
			...
			<TD>
				<INPUT class="txtNumeric" name="sAvanceFisico" id="sAvanceFisico" type="Text" size="20" maxlength="3" value="<%=sAvanceFisico%>"  onkeypress="valida(this);" onpaste="return validaPasteNum(this);"></TD>
			<TD>
				<INPUT class="txtNumeric" name="sAvanceFinanciero" id="sAvanceFinanciero" type="Text" size="20" maxlength="3" value="<%=sAvanceFinanciero%>"  onkeypress="valida(this);" onpaste="return validaPasteNum(this);"></TD>
		</TR>
<%
			} else {
%>
