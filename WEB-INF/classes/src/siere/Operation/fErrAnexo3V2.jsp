...
ErrAnexo3V2 oAnexo	= new ErrAnexo3V2();
String sPath = "../";

%>
<html>
<head>
	<title>Entrega - Recepción : Anexo III.5.2 (Errores en Carga Masiva)</title>
...
<tr>
	...
	<!-- Contenido -->
	<td valign="top">
<FORM action="fErrAnexo3V2.jsp" name="forma" method="post" >
	<TABLE align=center border=0 cellPadding=0 cellSpacing=0 width="100%">
		<TR>
			<TD class="TituloParrafo" width="70%">&nbsp;&nbsp;ERRORES DEL ANEXO III.5.2 - CARGA MASIVA&nbsp;&nbsp;</TD>
		</TR>
	</TABLE>		
