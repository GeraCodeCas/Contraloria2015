...
ErrAnexo3V6 oAnexo	= new ErrAnexo3V6();
String sPath = "../";

%>
<html>
<head>
	<title>Entrega - Recepción : Anexo III.5.6 (Errores en Carga Masiva)</title>
...
<tr>
	...
	<!-- Contenido -->
	<td valign="top">
<FORM action="fErrAnexo3V6.jsp" name="forma" method="post" >
	<TABLE align=center border=0 cellPadding=0 cellSpacing=0 width="100%">
		<TR>
			<TD class="TituloParrafo" width="70%">&nbsp;&nbsp;ERRORES DEL ANEXO III.5.6 - CARGA MASIVA&nbsp;&nbsp;</TD>
		</TR>
	</TABLE>		
