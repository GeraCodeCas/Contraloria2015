...
if (MultipartFormDataRequest.isMultipartFormData(request)){
	...
	if ((sOpcion != null) && (sOpcion.equalsIgnoreCase("UpLoad"))) {
        ...
        if ((files != null) || (!files.isEmpty())){
			...
			int[] iPaso = {20, 100, 1, 20, 20,10,10,5,5,255,1};
			...
			oCarga.setTabla("PasoAnexo3X");
			oCarga.setProcedimiento("Anexo3X");
			...
			oSeguridad.Bitacora(sUsuario, "Carga", "Anexo III.10", request.getRemoteAddr(), request.getRemoteHost(), request.getHeader("User-Agent"));
        }
	}
}
...
<head>
	...
	<title>Entrega - Recepción : Anexo III.10 (Archivos de Carga Masiva)</title>
	...
	<script>
		...
		function errores(){
			popBoxRize("Errores", 800, 600, "fErrAnexo3X.jsp?sIdFuncionario=<%=sIdFuncionario%>");
		}
	</script>
</head>
<body id="idBodyc">
<form method="post" action="cAnexo3X.jsp" name="upform" enctype="multipart/form-data">
