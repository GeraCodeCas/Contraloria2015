...
if (MultipartFormDataRequest.isMultipartFormData(request)){
	...
	if ((sOpcion != null) && (sOpcion.equalsIgnoreCase("UpLoad"))) {
        ...
        if ((files != null) || (!files.isEmpty())){
			...
			int[] iPaso = {20, 50, 1, 50, 50, 10, 10, 255};
			...
			oCarga.setTabla("PasoAnexo3IV2");
			oCarga.setProcedimiento("Anexo3IV2");
...
<head>
	...
	<title>Entrega - Recepción : Anexo III.4.2 (Archivos de Carga Masiva)</title>
	...
	<script>
		...
		function errores(){
			popBoxRize("Errores", 800, 600, "fErrAnexo3IV2.jsp?sIdFuncionario=<%=sIdFuncionario%>");
		}
	</script>
</head>
<body id="idBodyc">
<form method="post" action="cAnexo3IV2.jsp" name="upform" enctype="multipart/form-data">
