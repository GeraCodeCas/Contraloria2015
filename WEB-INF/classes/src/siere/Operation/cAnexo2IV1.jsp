...
if (MultipartFormDataRequest.isMultipartFormData(request)){
	...
	if ((sOpcion != null) && (sOpcion.equalsIgnoreCase("UpLoad"))) {
		...
		if ((files != null) || (!files.isEmpty())){
			...
			int[] iPaso = {50, 100, 20, 20, 50, 50, 50, 10, 20};
			...
			oCarga.setTabla("PasoAnexo2IV1");
			oCarga.setProcedimiento("Anexo2IV1");
			...
			oSeguridad.Bitacora(sUsuario, "Carga", "Anexo II.4.1", request.getRemoteAddr(), request.getRemoteHost(), request.getHeader("User-Agent"));
		}
	}
}
...
<head>
	...
	<title>Entrega - Recepción : Anexo II.4.1 (Archivos de Carga Masiva)</title>
	...
	<script>
		...
		function errores(){
			popBoxRize("Errores", 800, 600, "fErrAnexo2IV1.jsp?sIdFuncionario=<%=sIdFuncionario%>");
		}
	</script>
</head>
<body id="idBodyc">
<form method="post" action="cAnexo2IV1.jsp" name="upform" enctype="multipart/form-data">
...
<tr>
	...
	<td valign="top">
		...
		<!-- Etiqueta donde se aplican los encabezados de las tablas--><%
			...
			</tr><SCRIPT language="JavaScript">window.opener.vLoadCM = 0;</SCRIPT>
			<%} %>
