...
<html>
<head>
	<title>Entrega - Recepción : Anexo III.5.3 (Impresión)</title>
...
<tr>
	...
	<TR><TD class="TituloParrafoImpr">RELACIÓN DE EQUIPO DE VIDEO</TD></TR>  
	</TABLE>
	<TABLE cellPadding="0" cellSpacing="0" width="100%" BORDER="1" BORDERCOLOR="white">
		<TR align="middle">
...
if(!sEstatus.equals("0")){
		...
		String vClave = oAnexo3V3.GetClave(i)!=null?oAnexo3V3.GetClave(i):"";
		String vNumFactura = oAnexo3V3.GetNumFactura(i)!=null?oAnexo3V3.GetNumFactura(i):"";
		String vFecha = oAnexo3V3.GetFecha(i)!=null?oAnexo3V3.GetFecha(i):"";
		String vConcepto = oAnexo3V3.GetConcepto(i)!=null?oAnexo3V3.GetConcepto(i):"";
		...
		if(iLenCol > 40){
			...
			for(int x=1;x<=(iRowsXCol);x++){
				...
				if( (x + iRowsAnt) <= iMaxRowXPag) {
					vConcepto = vConcepto + temp.substring((40*(x-1)), max) + "<br>";
					}
				else {
		...
		String vImporte = oAnexo3V3.GetImporte(i)!=null?oAnexo3V3.GetImporte(i):"";
		...
		String vDesTipo = oAnexo3V3.GetDesTipo(oAnexo3V3.GetTipoPos(oAnexo3V3.GetTipo(i)));
