...
if (MultipartFormDataRequest.isMultipartFormData(request)){
	...
	if ((sOpcion != null) && (sOpcion.equalsIgnoreCase("UpLoad"))) {
        ...
        if ((files != null) || (!files.isEmpty())){
			...
			oCarga.setTabla("PasoAnexo3XVI");
			oCarga.setProcedimiento("Anexo3XVI");
			...
			oSeguridad.Bitacora(sUsuario, "Carga", "Anexo III.16", request.getRemoteAddr(), request.getRemoteHost(), request.getHeader("User-Agent"));
		}
	}
}
String sPath 			= "../";
...
<head>
	...
	<title>Entrega - Recepción : Anexo III.16 (Archivos de Carga Masiva)</title>
	...
	<script>
		...
		function errores(){
			popBoxRize("Errores", 800, 600, "fErrAnexo3XVI.jsp?sIdFuncionario=<%=sIdFuncionario%>");
		}
	</script>
</head>
<body id="idBodyc">
<form method="post" action="cAnexo3XVI.jsp" name="upform" enctype="multipart/form-data">
