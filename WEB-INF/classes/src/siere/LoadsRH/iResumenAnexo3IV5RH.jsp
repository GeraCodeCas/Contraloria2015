...
<tr>
	...
	<TABLE align=center border=0 cellPadding=0 cellSpacing=0 width="100%">
		<TR>
			<TD class="TituloParrafo" width="70%">&nbsp;&nbsp;RESUMEN DE CARGA DEL ANEXO III.4.5&nbsp;&nbsp;</TD>
		</TR>
	</TABLE>		
	<TABLE cellPadding="0" cellSpacing="0" width="100%" BORDER="1" BORDERCOLOR="white">
		...
		<TR align="left" bgcolor="<%=sBackColor%>" onMouseOver = "MouseDentro(this);this.style.cursor='hand';" onMouseOut="MouseFuera(this,'<%=sBackColor%>');" style="cursor:normal">
			...
			<TD>&nbsp;<%=oUnidadAdministrativa.GetPos(java.lang.Integer.parseInt(sIdUAdministrativa))>=0?oUnidadAdministrativa.GetNombre(oUnidadGobierno.GetPos(java.lang.Integer.parseInt(sIdUAdministrativa))):"(Desconocida)"%></TD>
